...
async def help(update, context):
    ...
    await update.message.reply_text(
        ...
        "/remind - бот начнет отправлять напоминания по времени.")  # при запуске функции remind программа будет отслеживать время задач,
        # однако она не сможет выполнять другия запросы пользователя
